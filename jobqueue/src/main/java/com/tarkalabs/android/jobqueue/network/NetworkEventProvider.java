 ...
 * This is not mandatory but highly suggested so that {@link com.tarkalabs.android.jobqueue.JobManager} can avoid
...
public interface NetworkEventProvider {
    ...
    interface Listener {
        /**
         * @param networkStatus {@link com.tarkalabs.android.jobqueue.network.NetworkUtil.NetworkStatus}
         */
