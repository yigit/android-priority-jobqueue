...
public interface JobManagerCallback {
     ...
     * {@link com.tarkalabs.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} while it was running.
     *
     * @see com.tarkalabs.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)
     * @see com.tarkalabs.android.jobqueue.JobManager#cancelJobsInBackground(CancelResult.AsyncCancelCallback, TagConstraint, String...)
     */
     ...
     *                         {@link com.tarkalabs.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} request.
